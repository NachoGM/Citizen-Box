...
public class SwiftyOnboard: UIView, UIScrollViewDelegate {
    ...
    fileprivate func colorFrom(start color1: UIColor, end color2: UIColor, precent: Float)->UIColor{
        ...
        return UIColor(red: CGFloat(cofd(color1.cgColor.components![0], color2.cgColor.components![0], precent)), green: (CGFloat(cofd(color1.cgColor.components![1], color2.cgColor.components![1], precent))), blue: (CGFloat(cofd(color1.cgColor.components![2], color2.cgColor.components![2], precent))), alpha: 1)
    }
